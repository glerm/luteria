...
%A todos e todas...\footnote{...que leram tudo, entenderam quase e acharam que foi pouco.}
%\end{agradecimentos}
% ---
...
Edward \citeonline{pearsall2004symmetry} observa na peça Mikrosmos 109 ("From the Island of Bali", já no motivo inicial, uma "célula germinativa"\ para outras transformações na peça; a construção simétrica esta presente tanto na construção do eixo [1,5,1] (Figura 15) quanto na construção uma escala completa de oito tons, que seria cortada ao meio por um intervalo ausente de Dó$\sharp$ (Figura 16).
