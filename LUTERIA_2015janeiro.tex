...
%\local{Brasil}
\data{04 de março de 2015, v0.99999-Defesa}
...
Resumindo: se a = 1 teremos $b \approx 0.61034 $. Se a=2 $b \approx 0.61034 \textbf{* 2} $. 
...
\begin{figure}[!h]
	...
	\begin{center}
	    \includegraphics[scale=0.3]{OMPD/OM-listasDELADO.png}
	\end{center}
	\legend{Fonte: autor }
\end{figure}
...
\begin{figure}[!h]
	...
	\begin{center}
	    \includegraphics[scale=0.3]{OMPD/manipulacao02.png}
	\end{center}
	\legend{Fonte: autor }
\end{figure}
...
\begin{figure}[!h]
	...
	\begin{center}
	    \includegraphics[scale=0.3]{OM_settheory/todas_triades.png}
	\end{center}
	\legend{Fonte: autor }
\end{figure}
...
Na figura 57 temos um exemplo de de segmentação feita manualmente, com seleção de mouse, e em seguida analisada automaticamente em interação com a escuta, revelando a escolha de uma coleçao octatonica ja na primeira frase melodica de oito notas (duas repetidas) de Mikrokosmos 109.
...
\begin{figure}[!h]
	\caption{\label{fig_grafico}Módulo de segmentação para análise dentro dos objetos chord-seq. }
	\begin{center}
	    \includegraphics[scale=0.4]{OM_settheory/SegmentaMikro109Octa.png}
	\end{center}
	\legend{Fonte: autor }
\end{figure}	
...
Para estes casos é possível desenvolver análises customizadas em linguagem Lisp, podendo também fazer chamadas das bibliotecas OM em seu código escrito. O procedimento mínimo para um registro de procedimento customizado de análise e segmentação esta ilustrado na figura 59.
