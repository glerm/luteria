...
\citeonline[p. 08]{lendvai1971bela} organiza uma visão geral da transformação dos conceitos de harmonia tonal funcional nas estratégias no que chama de \textit{"sistema de eixos"}\footnote{axis system}\ de Bartók a partir de seis destaques:
