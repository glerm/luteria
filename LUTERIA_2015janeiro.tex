...
Vemos na Figura 31 a comprovação do que já poderíamos supor pela própria sugestão de Bartók na partitura original (Figura 32) - o sustenido fixo da música é afirmado não como um cromatismo localizado ornamental mas algo que está ali para substituir a expectativa de resolução em Sol maior que o grau sensível Fá\# traria. Ao invés deste passo Fá\# $ \rightarrow $ Sol temos a figura de Dó\# atuando na dissonância que desloca a sensação de prolongamento I-V-I possível, figurando como trítono de Sol e com isso também impossibilitando a interpretação de que estaríamos simplesmente num modo Mixolídio de Sol pela ausência do Fá\#. 
