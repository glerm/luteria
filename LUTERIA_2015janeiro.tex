...
A revisão da literatura específica sobre o compositor Bela Bartók mostrou-se essencial como referência para construção de procedimentos de estilo pós-tonal sugeridos nos apontamentos. Como já previa o pesquisador de inteligência artificial Douglas Hofstadter na coleção de impressões sobre a pesquisa de geradores de estilo de David \citeonline{cope2004virtual} :
